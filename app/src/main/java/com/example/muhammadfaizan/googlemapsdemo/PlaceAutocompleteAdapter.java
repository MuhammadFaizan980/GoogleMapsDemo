...
public class PlaceAutocompleteAdapter
    ...
    private ArrayList<AutocompletePrediction> getAutocomplete(CharSequence constraint) {
        Log.i("tg", "Starting autocomplete query for: " + constraint);
        ...
        try {
            ...
            Log.i("tg", "Query completed. Received " + autocompletePredictions.getCount()
                    + " predictions.");
            ...
            Log.e("tg", "Error getting autocomplete prediction API call", e);
            return null;
        }
    }
}
